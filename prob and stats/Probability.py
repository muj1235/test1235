...
print("The probability of getting 21 on the first draw is:", (4/52)*(16/51) + (16/52)*(4/51), " so around 5 percent, because casinos want the adavantage this is why you should stop gambling.")